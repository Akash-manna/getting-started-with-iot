...
int led = D4;
char ssid[] = "rishabh";           // SSID of your home WiFi
char pass[] = "rishabh1994";            // password of your home WiFi

unsigned long askTimer = 0;

IPAddress server(192,168,43,52);       // the fix IP address of the server
WiFiClient client;
